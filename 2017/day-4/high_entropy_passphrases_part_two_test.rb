...
require_relative 'high_entropy_passphrases_part_two'

class HighEntropyPassphrasesPartTwoTest < Minitest::Test
  def test_validity_with_valid_passphrase
    input = 'abcde fghij'
    assert_equal true, HighEntropyPassphrasesPartTwo.valid?(input)
  end

  def test_validity_with_valid_passphrase_2
    input = 'a ab abc abd abf abj'
    assert_equal true, HighEntropyPassphrasesPartTwo.valid?(input)
  end

  def test_validity_with_valid_passphrase_3
    input = 'iiii oiii ooii oooi oooo'
    assert_equal true, HighEntropyPassphrasesPartTwo.valid?(input)
  end

  def test_validity_with_invalid_passphrase
    input = 'abcde xyz ecdab'
    assert_equal false, HighEntropyPassphrasesPartTwo.valid?(input)
  end

  def test_validity_with_invalid_passphrase_2
  ...
  def test_number_valid
    ...
    assert_equal 3, HighEntropyPassphrasesPartTwo.number_valid(input)
  end

  def test_number_valid_real_input
    ...
    assert_equal 223, HighEntropyPassphrasesPartTwo.number_valid(input)
  end
end
