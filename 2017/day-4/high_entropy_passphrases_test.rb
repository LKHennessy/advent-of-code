...
class HighEntropyPassphrasesTest < Minitest::Test
  def test_validity_with_valid_passphrase
    ...
    assert_equal true, HighEntropyPassphrases.valid?(input)
  end
  ...
  def test_validity_with_invalid_passphrase
    ...
    assert_equal false, HighEntropyPassphrases.valid?(input)
  end
  ...
  def test_number_valid
    ...
    assert_equal 2, HighEntropyPassphrases.number_valid(input)
  end
  ...
  def test_number_valid_real_input
    ...
    assert_equal 451, HighEntropyPassphrases.number_valid(input)
  end
end
